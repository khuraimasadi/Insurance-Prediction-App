...
This is app is predict the insurance of person based on features such as age, region, gender etc. It is a Regression based model that predict the numeric value of price. The model is trained on large dataset.
# Hi, I'm Abdullah! 👋
